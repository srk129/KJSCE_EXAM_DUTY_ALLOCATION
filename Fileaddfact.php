                        ...
                        <div class="row mb-2">
                          ...
                          <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                              ...
                              <li class="breadcrumb-item"><a href="Fileaddfact.php">Add</a></li>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="card card-primary">
                              ...
                              <div class="card-body">
                                <div class="form-group">
                                  <label for="Fid">Facuty Id</label>
                                  <input type="text" id="Fid" name="Fid" class="form-control" autofocus>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control custom-select" name="Fgender" id="Fgender">
                            ...
                            <div class="card card-secondary">
                              ...
                              <div class="card-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control custom-select" name="Fdept" id="Fdept">
                                    <option selected disabled value="">Select one</option>
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control custom-select" name="Fdesig" id="Fdesig">
                                    <option selected disabled value="">Select one</option>
            ...
            <div class="row mt-3">
              <div class="col-md-6">
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      <label for="input">Facuty Id</label>
                      <input type="text" id="input" class="form-control">
                    </div>
                    <div class="form-group">
                      <label for="inputN">Faculty Name</label>
                      <input type="text" id="inputN" class="form-control">
                    </div>
                    <div class="form-group">
...
<script>
  $('#insert_form').on('click', '#insert', function(event){  
        ...
        else if(!phonenum.match(phoneno))  
        {  
        swal.fire({
          icon: 'error',
        ...
        else if(!(($('#Femail').val()).match("^[a-zA-Z0-9.!#$%&'*+\=?^_`{|}~-]+@somaiya+.edu$")))
        {  swal.fire({
          icon: 'error',
          text:'Email-address is in wrong format',
        });
            //alert(" Email-address is in wrong format!");  
        }*/ 
...
function chkFunc(){
    ...
    var letterNumber = /^[0-9a-zA-Z\s]+$/;
      if (x.value.match(numbers)){
        swal.fire({
              icon: 'error',
              text:'Invalid input for name.Please enter alphabets only.',
            });
      ...
      if(eid.value.length >= 11){
        swal.fire({
              icon: 'error',
              text:'Invalid input for Faculty Id.Please enter an Id of valid  length',
            });
        return false;
      };
...
function pNum(){
  ...
  var letterNumber = /^[0-9a-zA-Z\s]+$/;
      if(y.value.length != 10){
        swal.fire({
              icon: 'error',
              text:'Invalid input for Phone Number.Please enter a valid phone number of length 10.',
            });
      ...
      else
      {
        swal.fire({
              icon: 'error',
              text:'Invalid input for Phone Number.Please enter numbers only.',
            });
...
function chkEmail(){
  ...
  if(!"^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@somaiya+.edu$".match(em.value))
      {
        swal.fire({
              icon: 'error',
              text:'Email id is in wrong format.',
            });
            return false;
      };
...
function chkDrop(){
  ...
  if (gen == "") {
    swal.fire({
              icon: 'error',
              text:'Please select a gender from the dropdown list.',
            });
  ...
  if (dep2 == "") {
    swal.fire({
              icon: 'error',
              text:'Please select a department from the dropdown list.',
            });
  ...
  if (design == "") {
    swal.fire({
              icon: 'error',
              text:'Please select a designation from the dropdown list.',
            });
      return false;
  }
};*/
