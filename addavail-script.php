...
include_once('commonavail.php');
      ...
      $common = new Common();
      $SheetUpdate = $common->uploadData($conn,$weeknum1,$department1,$daterange1,$facultyid1,$facultyname1);
      if ($SheetUpdate){
        echo "<script>alert('New record has been added successfully !');window.location.href='viewavail.php';</script>";
    }
?>