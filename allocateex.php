...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar scrollbar scrollbar-secondary">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="allocateex.php" class="nav-link active">
                  <i class="fas fa-plus nav-icon"></i>
                  <p>Allocate Exam</p>
              </a>
            </li>
  ...
  <?php
				...
				while($row = mysqli_fetch_assoc($result)) { ?>
                    ...
                    <!--<td align="center"><button class="btn btn-sm btn-primary generate style=color: white;"  data-toggle="modal" data-target="#exam_modal" type="submit">Allocate</button></td>-->
                    <td align="center"><input name="edit" type="button" value="Allocate" id="<?php echo $row['E_id'];?>" class="btn btn-primary edit_data" /></td>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="card card-primary">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="Exam_date" id="Exam_date" class="input form-control " >
                        ...
                        <input type="submit" name="insert" id="insert" value="Insert" class="btn btn-success" /></div>
                      <!-- /.card -->
                      </div>
                   </div>   
                 </div>
