          ...
          <section class="content">
            ...
            <div class="card">
              ...
              <?php
                ...
                $sql = "SELECT * FROM availfaculty";
                $result = $conn->query($sql);
                ?>
              <div class="table-responsive">
                <table class="table table-striped projects" id="tableview">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <td><?php echo $rows['department'];?></td>
                          ...
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <a class="btn btn-danger btn-sm"href="deleteavail.php?facultyid=<?php echo $rows['facultyid']; ?>">
