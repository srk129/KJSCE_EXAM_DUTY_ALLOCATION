  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="home.php" class="nav-link"><i class="fa fa-fw fa-home mr-1" ></i>Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="home.php" class="nav-link"><i class="fas fa-phone-alt mr-1" ></i>Contact</a>
      </li>
    </ul>
    ...
    <div class="sidebar scrollbar scrollbar-secondary">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <?php
            ...
            echo' <div class="image" style=" padding-top:26px;">';
            $image = $row1['imgurl'];
            ...
            echo'<p style="font-size:x-large;color: white; padding-left: -45px;">';
            echo "". $row["Fname"]. " ,";
            echo'<i class="fas fa-angle-right left ml-3" style="color: white;"></i></a>';
            echo '<p>' ;
            echo'</div>';
            }
