...
<body>
    ...
    <!-- <form method="get" name="form" action="tp.php">  -->
    <script>
        ...
        function onSuccess(googleUser) {
            ...
            if (clicked) {
                ...
                var usr_id = profile.getId();
                var usr_name = profile.getName();
                var usr_imgurl = profile.getImageUrl();
                var email = profile.getEmail();
                var id_token = googleUser.getAuthResponse().id_token;
                <?php
                 //$userid = echo"<script>usr_id;</script>";
                 //$name = echo"<script>usr_name;</script>";
                ?>
                ...
                $.ajax({
                    ...
                    console.log(usertype);
                        if (usertype == "admin") {
                            console.log("admin");
                            <?php 
                            header("Location: Fileaddfact.php?userid=");
                            ?>
                            //window.location.href = 'Fileaddfact.php?';//dev change this page php
                        } else if (usertype == "manager") {
                            console.log("manager");
                            window.location.href = 'managerdashboard.php';//dev change this page php
