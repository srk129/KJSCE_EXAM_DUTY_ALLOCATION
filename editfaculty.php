      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="editfaculty.php" class="nav-link active">
                ...
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" maxlength="10" id="Fphone" name="Fphone" class="form-control" required >
                    </div>
                  </div>
                  <!-- /.card-body -->
                </div>
...
<script>  
 $(document).ready(function(){  
      ...
      $('#insert_form').on('click', '#insert', function(event){  
           ...
           else if(!preg_match("^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@somaiya+.edu$", $('#Femail').val()))
           {  
             swal.fire({
              icon: 'error',
      ...
      $query = "UPDATE faculty_data SET 
                    ...
                    ?>
                     ...
                     <script type="text/javascript">
                      ...
                      window.location = "editfaculty.php";
                      </script>
                    <?php
                      }               
                    ?>
