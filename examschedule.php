...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">View Exam Schedule</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <?php
				...
				while($row = mysqli_fetch_assoc($result)) { ?>
                    ...
                    <td align="center"><?php echo $row['Course_Code'];?></td>
                    <td align="center"><?php echo $row['Course_Name'];?></td>
                    <td align="center"><?php echo $row['Exam_date'];?></td>
                    <td align="center"><?php echo $row['Exam_slot'];?></td>
                    ...
                    <td class="project-actions input-container">
                      ...
                      <input type="button" name="edit" value="Edit" id="<?php echo $row["E_id"]; ?>" class="btn btn-info btn-xs edit_data" />
                        </button>          
                    </td>
                    <td class="project-actions input-container">
                      <a href="deleteex.php?E_id=<?php echo $row["E_id"]; ?>" class="btn btn-danger btn-sm mr-1"  >
                            ...
                            <div class="card card-primary">
                              ...
                              <div class="row">
                                <div class="col-3 form-group">
                                  ...
                                  <label for="acadyear">Academic Yr</label>
                                  <select class="form-control custom-select" name="aca_year" id="acadyear" required> 
                                ...
                                <div class="col-3 form-group">
                                  ...
                                  <select class="form-control custom-select" name="exam" id="exam" required>
                                      <!--<option selected disabled>Select one</option>-->
                                ...
                                <div class="col-3 form-group">
                                  ...
                                  <select class="form-control custom-select" name="degree" id="degree" required>
                                      <!--<option selected disabled>Select one</option>-->
                              ...
                              <div class="row"> 
                                <div class="col-3 form-group">
                                  ...
                                  <select class="form-control custom-select" name="sem" id="sem" required>
                                    <!--<option selected disabled>Select one</option>-->
                                    <option>Odd</option>
                                    <option>Even</option>
                                  </select>
                                  ...
                                  <div class="col-3 form-group">
                                    <label for="semnum">Sem No.</label>
                                    <select class="form-control custom-select" name="sem_no" id="semnum" required>
                                      <!--<option selected disabled>Select one</option>-->
                                      <option>I</option>
                                      <option>II</option>
                                      <option>III</option>
                                ...
                                <div class="form-group">
                                    <label for="deptid">Dept Id</label>
                                              <select class="form-control custom-select" name="d_id" id="deptid" required>
                                                <!--<option selected disabled>Select one</option>-->
                                                <option>1</option>
                                                <option>2</option>
                                                <option>3</option>
                                ...
                                <div class="col-md-3 form-group">
                                  ...
                                  <div class="form-group">
                                    <label for="dept">Department</label>
                                              <select class="form-control custom-select" name="d_name" id="dept" required>
                                                <!--<option selected disabled>Select one</option>-->
                                                <option>COMPS</option>
                                                <option>ETRX</option>
                                                <option>EXTC</option>
                              ...
                              <div class="row"> 
                                <div class="col-3 form-group">
                                  ...
                                  <input type="text" id="cocode" class="form-control"/>
                                </div>
                                <div class="col-3 form-group">
                                  <label for="coname">Course Name</label>
                                  <input type="text" id="coname" class="form-control"/>
                                </div>
                                <div class="col-3 form-group">
                                  <label for="examdt">Exam Date</label>
                                  <input type="date" id="examdt" class="form-control"/>
                                </div>
                                <div class="col-3 form-group">
                                  <label for="examtime">Exam Time</label>
                                  <input type="text" id="examtime" class="form-control"/>
                                </div>
                                
                              </div>
                              <div class="row"> 
                              <div class="col-3 form-group">
                                  <label for="examslot">Exam Slot</label>
                                  <input type="text" id="examslot" class="form-control"/>
                                </div>
                                <div class="col-3 form-group">
                                  <label for="weeknum">Week Num</label>
                                  <input type="text" id="weeknum" class="form-control"/>
                                </div>
                              </div>
                              </div>
                              <!-- /.card-body -->
      ...
      $(document).on('click', '.edit_data', function(){  
           ...
           $.ajax({  
                ...
                success:function(data){  
                      $('#Eid').val(data.E_id); 
                     $('#acadyear').val(data.Academic_year);  
                     $('#exam').val(data.Year_slot);  
                     $('#degree').val(data.Degree);  
                     $('#year').val(data.Year);  
                     $('#sem').val(data.Sem);
                     $('#semnum').val(data.Sem_No);    
                     $('#deptid').val(data.Dept_id);
                     $('#dept').val(data.Dept_name);
                     $('#cocode').val(data.Course_Code); 
                     $('#coname').val(data.Course_Name); 
                     $('#examdt').val(data.Exam_date); 
                     $('#examslot').val(data.Exam_slot); 
                     $('#examtime').val(data.Exam_time); 
