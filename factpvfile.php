...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">View availability report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <?php
              ...
              <input type="button" name="view" value="View" id="<?php echo $row["facultyid"]; ?>" class="btn btn-secondary btn-xs view_data" />
        ...
        <a type="button"class="btn btn-info btn-sm editbtn"  data-toggle="modal" data-target="#myModal">
              ...
              <td class="project-actions input-container">
                <a class="btn btn-danger btn-sm" href="deleteavail.php?facultyid=<?php echo $row['facultyid']; ?>" >
...
<div id="dataModal" class="modal fade">  
      <div class="modal-dialog">  
          ...
          <div class="modal fade" id="myModal" role="dialog">
            <div class="modal-dialog">
            <form name="form" method="post" action="updateavailcode.php">
              <!-- Modal content-->
              <div class="modal-content">
                <div class="modal-header">
