    ...
    <div class="sidebar scrollbar scrollbar-secondary">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="leaveadd.php" class="nav-link active">
                  <i class="fas fa-plus nav-icon"></i>
      ...
      <div class="col-md-12">
        <div class="card-header p-2">
          <ul class="nav nav-pills bg-white">
            ...
            <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Add Faculty Leave </a></li>
          </ul>
        </div>
    </div>
    <!-- /.content-header -->
    <div class="card-body">
      <div class="tab-content">
        <div class="active tab-pane" id="activity">
          ...
          <!-- /.content-header -->
          <section>
            <form action="importleave.php" method="post" enctype="multipart/form-data">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="card card-primary">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group">
                          <label for="Fid">Faculty ID:</label>
                            <input type="text" class="form-control" name="Fid" id="Fid" ></input>
                          </div>
                        <div class="form-group">
                          ...
                          <label for="weeknum">Week No.</label>
                            <select class="form-control custom-select" name="weeknum" id="weeknum"> 
                              <option selected disabled id="zero">Select</option>
                          ...
                          <label for="department">Department</label>
                            <select class="form-control custom-select" name="department">
                              <option selected disabled id="0">Select one</option>
                    ...
                    <div class="card-footer">
                      <input type="submit" value="Submit" name="submit" id="submit" class="btn btn-success float-right">
                    </div>
                  <!-- /.card -->
                </div>
              </div>   
...
<script>  
 $(document).ready(function(){  
      ...
      $('#insert_form').on('click', '#submit', function(event){  
           ...
           else if($('#weeknum').id == "zero")  
           {  
              swal.fire({
                  icon: 'error',
                  text:'Week number is required',
                });
                //alert("Name is required");  
           }
