...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item ">
        <a class="nav-link" data-toggle="dropdown" href="home.php" onclick="signOut();">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <?php
          ...
          echo' <div style="padding-left:60px; padding-top:40px;">';
          $image = $row1['imgurl'];
          $imageData = base64_encode(file_get_contents($image));
          echo '<img src="data:image/jpeg;base64,'.$imageData.'"  width="700" height="700" />';   
          echo '</div>'; 
          }    
        ...
        while($row = mysqli_fetch_assoc($result1)) {
          ...
          echo "<br>". $row["Fname"]. "";
          echo '<p>' ;
          echo'<p class="user-panel" style="color: white;">';
          echo''. $row["Fdesignation"]. '<br><br>';
          echo'<p>';
          echo'</div>';
