...
<li class="nav-item has-treeview">
  ...
  <?php
				...
				while($row = mysqli_fetch_assoc($result)) { ?>
                    ...
                    <td align="center"><?php echo $row['Sem'];?>&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $row['Sem_No'];?></td>
                    <td align="center"><?php echo $row['Dept_id'];?>&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $row['Dept_name'];?></td>
                    <td align="center"><?php echo $row['Course_Code'];?>&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $row['Course_Name'];?></td>
                    ...
                    <td align="center"><button class="btn btn-sm btn-primary generate style=color: white;" data-toggle="modal" data-target="#myModal" type="submit">Allocate</button></td>
				</tr>
                      ...
                      <div class="col-md-12">
                        <div class="card card-primary">
                          ...
                          <div class="card-body">
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label for="totalroom">Total no. of rooms available:</label>
                                  <input type="number" name="totalroom" id="totalroom" class="input form-control " placeholder="Enter number of rooms avilable" required>

                                </div>
                                <!-- /.form-group -->
                                <div class="form-group">
                                  <label for="reqroom">Rooms required:</label>
                                  <input type="number" name="reqroom" id="reqroom" class="input form-control " placeholder="Enter number of rooms required" required>
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label for="totalfact">Total no. of faculty available:</label>
                                  <input type="number" name="totalfact" id="totalfact" class="input form-control " placeholder="Enter number of faculty avilable" required>

                                  <!-- /.input group -->
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group">
                                  <label for="reqfact">Faculty required:</label>
                                  <input type="number" name="reqfact" id="reqfact" class="input form-control " placeholder="Enter number of faculty required" required>
                            ...
                            <div class="row">
                              <div class="col">
                                <label for="maxduty">Maximum duty allocated to faculty:</label>
                                <select class="form-control select2bs4" name="maxduty" id="maxduty" disabled="disabled" style="width: 100%;">
