  ...
  <div class="content-wrapper">
                        ...
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rows['department'];?></td>
                          ...
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <a class="btn btn-primary btn-sm" href="#">
                                  ...
                                  <a class="btn btn-info btn-sm"  data-toggle="modal" data-target="#myModal" href="#">
    ...
    ?> 
            ...
            <div class="form-group">
              <label for="fileIp">File input</label>
              <div class="input-group">
                <div class="custom-file">
                  <input type="file" class="custom-file-input" name="excelDoc" id="excelDoc">
                  <label class="custom-file-label" for="fileIp">Choose file</label>
                </div>
              <div class="input-group-append">
          ...
          <form action ="update-script.php" method="post" enctype="multipart/form-data">
                          ...
                          <div class="col-md-12">
                            <div class="card card-primary">
                              ...
                              <div class="card-footer">
                                <button type="submit" class="btn btn-primary" id="submit" value="submit">Update</button>
                              </div>
                            <!-- /.card -->
                          </div>
                        </div>   
