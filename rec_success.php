        ...
        <div class="col-md-12">
              ...
              <div class="card-header p-2">
                <ul class="nav nav-pills bg-white">
                  <li class="nav-item"><a class="nav-link " href="#activity" data-toggle="tab">Upload file</a></li>
                  <li class="nav-item"><a class="nav-link active" href="#timeline" data-toggle="tab">Add Faculty</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
...
<div class="part-five part-four" id="Get-Started" style="display: flex; align-items: center; justify-content: center; background-size: auto !important;">
        <h3 class="text-info"> Record inserted Successfully!!</h3>
    </div>
