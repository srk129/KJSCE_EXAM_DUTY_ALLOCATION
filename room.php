                                ...
                                <div class="form-group"   >
                                    ...
                                    <?php
                                      include ('Datasource.php');
                                        ...
                                        $opt= '';
                                        $opt = '<select name="room_num" id="room_num" class="form-control selectpicker" data-live-search="true" multiple>';//to add dynamic room number select inputs
...
<script>
      ...
      $('#hidden_framework').val($('#room_num').val());
    });
</script>
