      ...
      <nav class="mt-2">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="roomview.php" class="nav-link active">
                  <i class=" fas fa-eye nav-icon"></i>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body table-responsive  " id="faculty_alloc">
                ...
                <thead>
                  ...
                  <tbody>
  <?php
				$sel_query="SELECT * FROM  room_alloc";
				$result = mysqli_query($conn,$sel_query);
				while($row = mysqli_fetch_assoc($result)) { ?>
                <td align="center"><?php  echo $row['E_id']; ?></td>
                ...
                <td align="center"><?php  echo $row['room_num']; ?></td>
       <!-- <td class="project-actions input-container">
        <a type="button"class="btn btn-info btn-sm editbtn"  data-toggle="modal" data-target="#myModal">
              ...
              <td class="project-actions input-container">
                <a href="deleteroomalloc.php?room_num=<?php echo $row["room_num"]; ?> & E_id=<?php echo $row["E_id"]; ?>" class="btn btn-danger btn-sm mr-1"  >
